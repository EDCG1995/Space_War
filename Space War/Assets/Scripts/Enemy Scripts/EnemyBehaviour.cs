...
public class EnemyBehaviour : MonoBehaviour
{
    ...
    private ScoreInterface scoreInterfaceScript;
    private int enemyScore = 2;
    
    void Start()
    {
        scoreInterfaceScript = GameObject.Find("Score").GetComponent<ScoreInterface>();
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.CompareTag("Shot")) 
        {
            ...
            scoreInterfaceScript.score += enemyScore;
        }
