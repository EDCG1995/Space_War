...
public class EnemyManager : MonoBehaviour
{
    ...
    private PlayerController playerControllerStript;
    void Start()
    {
        playerControllerStript = GameObject.Find("Player").GetComponent<PlayerController>();
    }
    ...
    void Update()
    {
        ...
        if (enemiesOnField <= 1 && !playerControllerStript.gameOver) 
        {
